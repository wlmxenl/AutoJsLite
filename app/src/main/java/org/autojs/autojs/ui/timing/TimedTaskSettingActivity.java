...
public class TimedTaskSettingActivity extends BaseActivity {
    ...
    @OnCheckedChanged({R.id.daily_task_radio, R.id.weekly_task_radio, R.id.disposable_task_radio, R.id.run_on_broadcast})
    ...
    @OnClick(R.id.disposable_task_time_container)
    ...
    @OnClick(R.id.disposable_task_date_container)
